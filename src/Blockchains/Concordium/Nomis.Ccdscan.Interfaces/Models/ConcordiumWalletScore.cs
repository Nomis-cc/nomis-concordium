// ------------------------------------------------------------------------------------------------------
// <copyright file="ConcordiumWalletScore.cs" company="Nomis">
...
{
    /// <summary>
    /// Concordium wallet score.
    /// </summary>
    public class ConcordiumWalletScore :
        IWalletScore<ConcordiumWalletStats, ConcordiumTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public ConcordiumWalletStats? Stats { get; set; }
    }
}