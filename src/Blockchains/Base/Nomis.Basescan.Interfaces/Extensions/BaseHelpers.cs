// ------------------------------------------------------------------------------------------------------
// <copyright file="BaseHelpers.cs" company="Nomis">
...
namespace Nomis.Basescan.Interfaces.Extensions
{
    /// <summary>
    /// Extension methods for base.
    /// </summary>
    public static class BaseHelpers
    {
        ...
        public static string GetTokenUid(this IBasescanAccountNftTokenEvent token)
        {
