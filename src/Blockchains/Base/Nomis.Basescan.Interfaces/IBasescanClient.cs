// ------------------------------------------------------------------------------------------------------
// <copyright file="IBasescanClient.cs" company="Nomis">
...
namespace Nomis.Basescan.Interfaces
{
    ...
    /// Basescan client.
    /// </summary>
    public interface IBasescanClient
    {
        /// <summary>
        /// Get the account balance in Wei.
        /// </summary>
        /// <param name="address">Account address.</param>
        /// <returns>Returns <see cref="BasescanAccount"/>.</returns>
        Task<BasescanAccount> GetBalanceAsync(string address);
        ...
        /// <returns>Returns <see cref="BasescanAccount"/>.</returns>
        Task<BasescanAccount> GetTokenBalanceAsync(string address, string contractAddress);
