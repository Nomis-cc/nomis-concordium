// ------------------------------------------------------------------------------------------------------
// <copyright file="BaseWalletScore.cs" company="Nomis">
...
namespace Nomis.Basescan.Interfaces.Models
{
    ...
    /// Base wallet score.
    /// </summary>
    public class BaseWalletScore :
        IWalletScore<BaseWalletStats, BaseTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public BaseWalletStats? Stats { get; set; }
    }
}